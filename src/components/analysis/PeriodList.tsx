import { Calendar, CheckCircle, XCircle, HelpCircle, Paperclip, Edit2, Trash2 } from 'lucide-react';
import { Periodo } from '../../hooks/useBenefitAnalysis';

interface PeriodListProps {
  periodos: Periodo[];
  diffMonths: (d1: string, d2: string) => number;
  fmtDate: (d: string) => string;
  handleEditClick: (p: Periodo) => void;
