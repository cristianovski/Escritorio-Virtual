...
export function Layout() {
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans text-slate-800 selection:bg-emerald-100 selection:text-emerald-900">
      ...
      {/* SIDEBAR FIXA - MENU LATERAL LIMPO E DIRETO */}
      <aside className="w-72 bg-white flex flex-col border-r border-slate-200 hidden md:flex shadow-xl z-20">
        <div className="p-8 border-b border-slate-100 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 uppercase font-bold tracking-widest mt-1">Advocacia Estratégica</p>
          </div>
        </div>
        ...
        <nav className="flex-1 p-6 space-y-2 overflow-y-auto">
            ...
            {/* ONDE ANTES ERA CARTEIRA DE CLIENTES, AGORA É INÍCIO */}
            ...
            <div className="text-[10px] uppercase font-bold text-slate-400 tracking-wider mt-6 mb-2 px-2">Gestão Financeira</div>
